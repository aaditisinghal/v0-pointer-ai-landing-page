  ...
  const pricingPlans = [
    {
      ...
      features: [
        ...
        "Carbon Receipts for every call",
    ...
    },
    {
      ...
      features: [
        ...
        "Org-wide dashboard",
        "Cost, CO₂, latency by team",
        "ESG-ready reports",
        "Region policies & caching rules",
        "Priority support",
    ...
    },
    {
      ...
      features: [
        ...
        "Savings-share pricing available",
      ],
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your AI workload. Save 30-50% on LLM costs <br /> and get verifiable Carbon Receipts
            for every request.
          </p>
        </div>
        <div className="pt-4">
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Developer" ? "text-gray-800" : plan.name === "Team" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              <div
                className={`self-stretch text-sm font-medium leading-tight ${plan.popular ? "text-primary-foreground/70" : "text-muted-foreground"}`}
              >
                {plan.name === "Developer" ? "Start Free Trial today:" : "Everything in Developer +"}
              </div>
